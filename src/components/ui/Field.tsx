...
const inputBase =
  ...
  // Locked (read) state: still legible, but visibly not a box you can type in.
  'disabled:bg-bg/40 disabled:border-transparent disabled:text-ink disabled:opacity-100 disabled:cursor-default';
