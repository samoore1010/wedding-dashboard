...
export const downloadGuestTemplate = () => {
  const rows: string[][] = [
    GUEST_HEADERS,
    ['The Smith Family', 'John Smith', 'Adult', 'Yes', 'Beef', '', 'Groom', 'Groom Family', 'Invited', 'Yes', 'jsmith@email.com', '12 Oak St, Denver CO', '', ''],
    ['The Smith Family', 'Mary Smith', 'Adult', 'Yes', 'Fish', 'Gluten-free', 'Groom', 'Groom Family', 'Invited', 'Yes', 'jsmith@email.com', '12 Oak St, Denver CO', '', ''],
    ['Jane Doe', 'Jane Doe', 'Adult', 'Waiting', '', '', 'Bride', 'Bride Friends', 'Invited', 'No', 'jane@email.com', '', '', 'College roommate'],
  ];
